...
$string['choiceplaceholder'] = 'Choice text (plain text, no HTML)';
$string['choicesintro'] = 'Type at least {$a} choices below, as plain text (no HTML formatting). Tick the "Correct answer" box next to each correct choice. Blank rows are ignored when the question is saved.';
...
$string['movechoicedown'] = 'Move this choice down';
$string['movechoiceup'] = 'Move this choice up';
...
$string['removeanswer'] = 'Remove this choice';
