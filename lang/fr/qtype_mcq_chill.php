...
$string['choiceplaceholder'] = 'Texte de la réponse (texte brut, sans HTML)';
$string['choicesintro'] = 'Saisissez au moins {$a} réponses ci-dessous, en texte brut (sans mise en forme HTML). Cochez la case « Bonne réponse » en face de chaque bonne réponse. Les lignes laissées vides sont ignorées à l\'enregistrement.';
...
$string['movechoicedown'] = 'Descendre cette réponse';
$string['movechoiceup'] = 'Monter cette réponse';
...
$string['removeanswer'] = 'Supprimer cette réponse';
